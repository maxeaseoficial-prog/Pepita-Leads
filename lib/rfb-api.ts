  ...
  try {
    ...
    return (body.matches||[]).flatMap(match=>{
      ...
      return [{
        ...
        statusCode:record.statusCode?String(record.statusCode):(record.status?String(record.status):null),
        ...
        companySizeCode:record.companySizeCode?String(record.companySizeCode):null,
