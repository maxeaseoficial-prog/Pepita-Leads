        ...
        {loading||!detail?<div className="loadingDetail"><img src="/pepita/working.png" alt=""/><strong>Carregando dossiê...</strong></div>:(
          <>
            ...
            <div className="detailGrid">
              ...
              <DetailSection title="Contato"><Definition rows={[["Telefone público",detail.phone||"Não informado"],["Telefone cadastral",detail.registeredPhone||"Não localizado"],["Telefone cadastral 2",detail.registeredPhone2||"Não localizado"],["E-mail cadastral",detail.email||"Não informado"],["Site",detail.website||"Não encontrado"],["Instagram",detail.social?.instagram?.url||"Não confirmado"]]}/></DetailSection>
